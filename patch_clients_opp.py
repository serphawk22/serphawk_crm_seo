...
filepath = 'frontend/src/app/admin/clients/[id]/components/tabs/OpportunitiesTab.tsx'
...
state_insert = """
  ...
  useEffect(() => {
    if (client?.id && activeSubTab === 'emails') {
      fetch(`${API_BASE_URL}/clients/${client.id}/research`)
...
print("Success patching Clients OpportunitiesTab")
