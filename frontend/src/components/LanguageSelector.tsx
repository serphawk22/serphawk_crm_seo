      ...
      <motion.button
        ...
        className={cn(
          ...
          isOpen
            ...
            : "hover:bg-slate-50 hover:border-slate-200 text-slate-600 dark:hover:bg-slate-800 dark:text-slate-300 dark:hover:border-slate-700"
        )}
      >
        ...
        <div className="flex items-center gap-1.5 ml-1">
          ...
          <span className="uppercase text-[10px] font-black tracking-wider text-slate-400 dark:text-slate-500">
            {currentLang.code}
          </span>
        </div>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 top-full mt-2 w-56 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-xl overflow-hidden z-50"
          >
            <div className="px-4 py-3 border-b border-slate-100 dark:border-slate-800/50 bg-slate-50/50 dark:bg-slate-800/30">
